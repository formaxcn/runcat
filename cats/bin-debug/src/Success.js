...
var Success = (function (_super) {
    ...
    function Success() {
        _super.call(this);
        this.goodtlt = ["塞外高手", "神精病博士", "神经大神", "你是我的小苹果", "院长派来的救兵", "精神病院长", "扫地僧", "传说中的高手", "风骚的少年", "白天睡觉喵", "隔壁王伯伯"];
        this.normaltlt = ["神经大条", "我是处女座的", "停不下来", "你是我的小苹果", "喵了个咪的", "M78星人", "凤姐夫", "笑而不语"];
        var succed = new egret.Bitmap(RES.getRes("victory_bg"));
    ...
    var __egretProto__ = Success.prototype;
    __egretProto__.score = function (sc) {
...
Success.prototype.__class__ = "Success";
